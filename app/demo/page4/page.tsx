    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{ color: isLocked ? "#4b5563" : "var(--text-primary)", fontFamily: "Syne, sans-serif" }}
          >
            {mod.title}
          </span>
        </div>
      ...
      {isInProgress && mod.progress !== undefined && (
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold" style={{ color: "#f59e0b", fontFamily: "Syne, sans-serif" }}>
            {mod.progress}%
          </span>
        </div>
      )}
            ...
            >
              ...
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-base" style={{ fontFamily: "Syne, sans-serif", color: track.color }}>
                    {track.title}
                  </span>
                </div>
                <span
              ...
              <div className="flex flex-col gap-2 pl-1 border-l-2" style={{ borderColor: "var(--border)" }}>
                {track.modules.map((mod) => (
                  <div key={mod.title} className="pl-4 relative">
                    <div
                      className="absolute left-0 top-4 w-2 h-2 rounded-full -translate-x-[5px]"
                      style={{
                        background:
                          mod.status === "completed"  ? "#16a34a" :
                          mod.status === "in-progress" ? "#f59e0b" : "var(--border)",
                      }}
                    />
                    <ModuleCard mod={mod} />
                  </div>
          ...
          >
            ...
            {[
              ...
              <div key={s.label} className="flex justify-between items-center">
                ...
                <span className="font-bold text-sm" style={{ fontFamily: "Syne, sans-serif", color: "var(--accent-mint)" }}>
                  {s.value}
                </span>
              </div>
            ))}
