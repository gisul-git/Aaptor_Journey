    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            ...
            style={{ fontFamily: "Syne, sans-serif", color: "#9ca3af" }}
          >
            —
          </span>
            ...
            <div key={item.skill} className="flex flex-col gap-1.5">
              <div className="flex justify-between items-center">
                ...
                <span
                  ...
                  style={{ color: skillColor(item.level), fontFamily: "Syne, sans-serif" }}
                >
                  {item.level}%
                </span>
              </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="text-sm font-semibold" style={{ color: "#6b7280", fontFamily: "Syne, sans-serif" }}>
            No Learning History
          </p>
        ...
        >
          ...
          <p className="text-xs leading-relaxed" style={{ color: "#9ca3af" }}>
            Skill benchmarks cannot be verified without an assessment.
          </p>
        </motion.div>
      </div>
    </motion.div>
