        ...
        >
          ...
          >
            <div
              ...
              style={{ background: "#1a2e1f", borderBottom: "1px solid var(--border)" }}
            >
              <span className="text-xs" style={{ color: "var(--text-muted)", fontFamily: "Syne, sans-serif" }}>
                rahul_answer.js
              </span>
              <span
                ...
                {scoreBreakdown.map((item) => (
                  <div key={item.label} className="flex flex-col gap-1">
                    <div className="flex justify-between text-xs">
                      ...
                      <span
                        style={{ color: scoreColor(item.value), fontFamily: "Syne, sans-serif", fontWeight: 600 }}
                      >
                        {item.value}%
                      </span>
                    </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span
                ...
                style={{ color: "var(--accent-mint)", fontFamily: "Syne, sans-serif" }}
              >
                Aaptor AI
              </span>
            </div>
            <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
              ...
              <span style={{ color: "var(--accent-mint)" }}>sliding window with a hash map</span> for
              O(n) efficiency. Edge cases like empty strings and unicode characters need handling.
            </p>
          </div>
