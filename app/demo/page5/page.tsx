      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              { label: "Commits", value: "143" },
              { label: "Active Repos", value: "12" },
              { label: "Top Lang", value: "Python" },
            ].map((s) => (
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            {[
              { title: "The Complete DSA Bootcamp", progress: 100 },
              { title: "AWS Solutions Architect", progress: 67 },
            ].map((c) => (
              <div key={c.title} className="flex flex-col gap-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs font-semibold" style={{ fontFamily: "Syne, sans-serif", color: c.progress === 100 ? "#16a34a" : "#7c3aed" }}>
                      {c.progress}%
                    </span>
                  </div>
                </div>
